...
@section('content')
        ...
        <div class="">
            ...
            <div class="row rg-30">
                ...
                <div class="col-md col-sm-12">
                    <div class="h-100 zNews-item-one">
                        <div class="content">
                            <h4 class="title">{{ __('Total Customer') }}</h4>
                            <div class="d-flex justify-content-between mt-20">
                                <h2 class="fs-5 fw-semibold mt-1 title">{{$totalCustomer}}</h2>
                                <div class="d-flex">
                ...
                <div class="col-md col-sm-12">
                    <div class="h-100 zNews-item-one">
                        <div class="content">
                            <h4 class="title">{{ __('Subscriptions') }}</h4>
                            <div class="d-flex justify-content-between mt-20">
                                <h2 class="fs-5 fw-semibold mt-1 title">{{ $totalSubscription }}</h2>
                                <div class="d-flex">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="h-100 zNews-item-one">
                        <div class="content">
                            <div class="d-flex items-center justify-content-between w-full">
                                <h4 class="title">{{ __('Monthly Recurring Revenue') }}</h4>
                            </div>
                            <div class="d-flex justify-content-between mt-20">
                                <h2 class="fs-5 fw-semibold mt-1 title">{{showPrice($monthlyRecurringRevenue)}}</h2>
                                <div class="d-flex">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <path
                ...
                <div class="row rg-30">
                    <div class="col-md-6">
                        <div class="zNews-item-one">
                            <div class="content">
                                <h4 class="title mb-3">{{ __('Total Subscription') }}</h4>
    ...
    <input type="hidden" id="product-sold-out-chart-data-route" value="{{route('admin.product-sold-out-chart-data')}}">
    <input type="hidden" id="daily-subscriber-chart-data-route" value="{{route('admin.daily-subscriber-chart-data')}}">
@endsection
