...
<div class="zSidebar" data-background="{{ asset('user/images/sidebar-bg.png') }}">
    ...
    @if (auth()->user()->role == USER_ROLE_ADMIN)
        <a href="{{ route('admin.dashboard') }}" class="d-block mx-26 mb-27 max-w-146 pt-23">
            <img class="max-h-35" src="{{ getSettingImage('app_logo_white') }}" alt="{{ getOption('app_name') }}" />
        </a>
    @else
        <a href="{{ route('admin.dashboard') }}" class="d-block mx-26 mb-27 max-w-146 pt-23">
            <img class="max-h-35" src="{{ getSettingImage('app_logo_white') }}" alt="{{ getOption('app_name') }}" />
    ...
    <div class="zSidebar-fixed">
        <ul class="zSidebar-menu" id="sidebarMenu">
            ...
            @if (isAddonInstalled('SUBSAAS') > 0)
                ...
                <li>
                    <a href="{{ route('admin.packages.user') }}"
                        class="d-flex align-items-center cg-10 {{ $activePackageUser ?? '' }}">
            ...
            <li>
                <a href="{{ route('admin.user.list') }}"
                    class="d-flex align-items-center cg-10 {{ $showUserList ?? '' }}">
                    <div class="d-flex {{ isset($showUserList) ? 'active' : 'collapsed' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <circle cx="9" cy="6" r="4" stroke="white" stroke-opacity="0.7"
                                stroke-width="1.5" />
                            <path d="M15 9C16.6569 9 18 7.65685 18 6C18 4.34315 16.6569 3 15 3" stroke="white"
                                stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round" />
                            <ellipse cx="9" cy="17" rx="7" ry="4" stroke="white"
                ...
                <a href="{{ route('admin.setting.application-settings') }}"
                    ...
                    <div class="d-flex {{ isset($activeApplicationSetting) ? 'active' : 'collapsed' }}">
                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                            ...
                            <circle cx="12" cy="12" r="3" stroke="white" stroke-opacity="0.7"
                                stroke-width="1.5" />
                        </svg>
                    </div>
            ...
            <li>
                <a href="{{ route('admin.setting.configuration-settings') }}"
                    class="d-flex align-items-center cg-10 {{ $showManageApplicationSetting ?? '' }}">
                    <div class="d-flex {{ isset($showManageApplicationSetting) ? 'active' : 'collapsed' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M7.84308 3.80211C9.8718 2.6007 10.8862 2 12 2C13.1138 2 14.1282 2.6007 16.1569 3.80211L16.8431 4.20846C18.8718 5.40987 19.8862 6.01057 20.4431 7C21 7.98943 21 9.19084 21 11.5937V12.4063C21 14.8092 21 16.0106 20.4431 17C19.8862 17.9894 18.8718 18.5901 16.8431 19.7915L16.1569 20.1979C14.1282 21.3993 13.1138 22 12 22C10.8862 22 9.8718 21.3993 7.84308 20.1979L7.15692 19.7915C5.1282 18.5901 4.11384 17.9894 3.55692 17C3 16.0106 3 14.8092 3 12.4063V11.5937C3 9.19084 3 7.98943 3.55692 7C4.11384 6.01057 5.1282 5.40987 7.15692 4.20846L7.84308 3.80211Z"
        ...
        <!-- <li>
                <a href="{{ route('admin.setting.package-template') }}"
                    class="d-flex align-items-center cg-10 {{ $activeCurrenciesSetting ?? '' }}">
                    <div class="d-flex {{ isset($activeCurrenciesSetting) ? 'active' : 'collapsed' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
           ...
           <li>
                <a href="{{ route('admin.setting.package-template') }}"
                    class="d-flex align-items-center cg-10 {{ $activePackageSetting ?? '' }}">
                    <div class="d-flex {{ isset($activePackageSetting) ? 'active' : 'collapsed' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M22 10C22.0185 10.7271 22 11.0542 22 12C22 15.7712 22 17.6569 20.8284 18.8284C19.6569 20 17.7712 20 14 20H10C6.22876 20 4.34315 20 3.17157 18.8284C2 17.6569 2 15.7712 2 12C2 8.22876 2 6.34315 3.17157 5.17157C4.34315 4 6.22876 4 10 4H13"
