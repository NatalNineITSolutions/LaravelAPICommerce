...
class VersionUpdateController extends Controller
{
    ...
    public function versionFileUpdate(Request $request)
    {
        ...
        $path = storage_path('app/public/source-code.zip');
        if (file_exists($path)) {
        ...
        return view('version_update.main-update', $data);
    }
    ...
    public function versionFileUpdateStore(Request $request)
    {
        ...
        set_time_limit(1200);
        $path = storage_path('app/pubic/source-code.zip');
        ...
        if (file_exists($path)) {
            ...
            if ($res === true) {
                ...
                try {
                    ...
                    $zipPath = storage_path('app/public/source-code.zip');
